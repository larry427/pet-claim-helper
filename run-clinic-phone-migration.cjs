...
async function runMigration() {
  console.log('🔧 ADDING clinic_phone COLUMN TO claims TABLE')
  console.log('='.repeat(80))

  // Read the SQL file
  const sqlPath = path.join(__dirname, 'server', 'migrations', 'add-clinic-phone.sql')
  ...
  console.log('2. Copy the SQL from server/migrations/add-clinic-phone.sql')
  console.log('3. Paste it into the SQL Editor')
  console.log('4. Click "Run"')
  console.log('5. Done!')

  console.log('\n🔍 OR try running via RPC...')
