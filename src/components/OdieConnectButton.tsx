...
// ---------------------------------------------------------------------------
// Shared API + Supabase logic
// ---------------------------------------------------------------------------

async function fetchOdiePolicy(policyNumber: string): Promise<{ ok: boolean; policy?: OdiePolicy; error?: string }> {
...
async function saveOdiePolicyToPet(
  petId: string,
  policy: OdiePolicy,
